...
import gr.aueb.cf.ch14.servises.CodingFactorySingleton;
import gr.aueb.cf.ch14.servises.HelloUtil;

public class Main {
    public static void main(String[] args) {
        Teacher teacher1 = new Teacher(1, "Ath.", "Athanasios");
        Teacher teacher2 = new Teacher(1, "A.", "Gianoutsou");
